...
public class LegacyMetaServerProvider implements MetaServerProvider {
  ...
  private void initialize() {
    ...
    domains.put(Env.DOCKER1, getMetaServerAddress(prop, "docker1_meta", "docker1.meta"));
    domains.put(Env.DOCKER2, getMetaServerAddress(prop, "docker2_meta", "docker2.meta"));
    domains.put(Env.DOCKER3, getMetaServerAddress(prop, "docker3_meta", "docker3.meta"));
    domains.put(Env.DOCKER4, getMetaServerAddress(prop, "docker4_meta", "docker4.meta"));
    domains.put(Env.DOCKER5, getMetaServerAddress(prop, "docker5_meta", "docker5.meta"));
